...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_comentatorId_fkey" FOREIGN KEY ("comentatorId") REFERENCES "User"("id") ON DELETE NO ACTION ON UPDATE CASCADE;
